...
if __name__ == '__main__':
    ...
    for i, x in enumerate(cc_data['images']):
        ...
        for cat_id, cat_names in class_data.items():
            # if cat_id not in [1, 2, 3, 4, 7, 8, 9, 15, 16, 19, 20, 23, 24, 25, 27, 31, 33, 34, 35, 38, 42, 44, 48, 50, 51, 52, 53, 54, 55, 56, 57, 59, 60, 62, 65, 70, 72, 73, 74, 75, 78, 79, 80, 82, 84, 85, 86, 90]:
                # continue
            find = False
            for c in cat_names:
