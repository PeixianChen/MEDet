...
from ..data.datasets.coco_zeroshot import categories_seen, categories_unseen, categories_other
...
class CustomCOCOEvaluator(COCOEvaluator):
    def _derive_coco_results(self, coco_eval, iou_type, class_names=None):
        ...
        other_names = set([x['name'] for x in categories_other])
        results_per_category = []
        results_per_category50 = []
        results_per_category50_seen = []
        results_per_category50_unseen = []
        results_per_category50_other = []
        results_per_category_recall = []
        ...
        for idx, name in enumerate(class_names):
            ...
            # results_per_category_recall.append(("{}".format(name), float(ap * 100)))
            results_per_category_recall.append(float(ap * 100))
            # 
            ...
            if name in other_names:
                results_per_category50_other.append(float(ap50 * 100))

        print(results_per_category_recall)
        # tabulate it
        ...
        self._logger.info(
            "Other {} AP50: {}".format(
                iou_type,
                sum(results_per_category50_other) / len(results_per_category50_other),
            ))
        ...
        # results["AP50-other"] = sum(results_per_category50_other) / len(results_per_category50_other)
        return results